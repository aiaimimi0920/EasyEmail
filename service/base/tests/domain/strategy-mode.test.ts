...
describe("mail strategy mode", () => {
  ...
  it("recognizes mail2925, m2u, moemail, im215 and etempmail as canonical provider types", () => {
  ...
  it("includes m2u, 2925, guerrillamail and etempmail in external-api selections", () => {
    const mode = resolveMailStrategyMode({
      providerSelections: ["mailtm", "m2u", "mail2925", "guerrillamail", "moemail", "im215", "duckmail", "tempmail-lol", "etempmail"],
    });
