...
export const MAIL_PROVIDER_GROUPS: MailProviderGroupDescriptor[] = [
  ...
  {
    key: "temporam",
    displayName: "Temporam",
    providerTypeKeys: ["temporam"],
    description: "Temporam anonymous web-flow temporary mailbox provider.",
  },
  {
    key: "mail2925",
...
export const MAIL_BUSINESS_STRATEGIES: MailBusinessStrategyDescriptor[] = [
  ...
  },
  {
    ...
    providerGroupOrder: ["gptmail", "mailtm", "m2u", "temporam", "mail2925", "guerrillamail", "moemail", "im215", "duckmail", "tempmail-lol", "etempmail", "cloudflare_temp_email"],
  ...
  },
  {
    ...
    providerGroupOrder: ["cloudflare_temp_email", "mailtm", "m2u", "temporam", "mail2925", "guerrillamail", "moemail", "im215", "duckmail", "tempmail-lol", "etempmail", "gptmail"],
