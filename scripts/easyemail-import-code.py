...
IMPORT_CODE_PREFIX = "easyemail-import-v1."
...
def decode_import_code(import_code: str) -> dict[str, Any]:
    ...
    if payload.get("kind") != "easyemail-import-code":
...
def bundle_for_import_code(import_code: str, payload: dict[str, Any]) -> dict[str, Any]:
    return {
        "schemaVersion": 1,
        "kind": "easyemail-import-code-bundle",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate, inspect, encrypt, and decrypt EasyEmail distribution import codes.")
