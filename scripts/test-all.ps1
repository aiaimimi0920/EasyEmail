...
$previousGranularSecrets = @{
    ...
    EASYEMAIL_PROVIDER_GPTMAIL_KEYS_TEXT = $env:EASYEMAIL_PROVIDER_GPTMAIL_KEYS_TEXT
    EASYEMAIL_PROVIDER_TEMPMAIL_LOL_BASE_URL = $env:EASYEMAIL_PROVIDER_TEMPMAIL_LOL_BASE_URL
    EASYEMAIL_PROVIDER_M2U_BASE_URL = $env:EASYEMAIL_PROVIDER_M2U_BASE_URL
    EASYEMAIL_PROVIDER_M2U_PREFERRED_DOMAIN = $env:EASYEMAIL_PROVIDER_M2U_PREFERRED_DOMAIN
    EASYEMAIL_PROVIDER_M2U_UPSTREAM_PROXY_URL = $env:EASYEMAIL_PROVIDER_M2U_UPSTREAM_PROXY_URL
    EASYEMAIL_PROVIDER_M2U_USE_EASY_PROXY_ON_CAPACITY = $env:EASYEMAIL_PROVIDER_M2U_USE_EASY_PROXY_ON_CAPACITY
    EASYEMAIL_PROVIDER_TMAILOR_BASE_URL = $env:EASYEMAIL_PROVIDER_TMAILOR_BASE_URL
    EASYEMAIL_PROVIDER_TMAILOR_ACCESS_TOKEN = $env:EASYEMAIL_PROVIDER_TMAILOR_ACCESS_TOKEN
    ...
    EASYEMAIL_USERSCRIPT_TMAILOR_ACCESS_TOKEN = $env:EASYEMAIL_USERSCRIPT_TMAILOR_ACCESS_TOKEN
...
'@
    ...
    $env:EASYEMAIL_PROVIDER_GPTMAIL_KEYS_TEXT = @'
gptmail-key-a
gptmail-key-b
'@
    $env:EASYEMAIL_PROVIDER_TEMPMAIL_LOL_BASE_URL = 'https://api.tempmail.lol/v2'
    $env:EASYEMAIL_PROVIDER_M2U_BASE_URL = 'https://api.m2u.io'
    $env:EASYEMAIL_PROVIDER_M2U_PREFERRED_DOMAIN = 'edu.kg'
    $env:EASYEMAIL_PROVIDER_M2U_UPSTREAM_PROXY_URL = 'http://127.0.0.1:8080'
    $env:EASYEMAIL_PROVIDER_M2U_USE_EASY_PROXY_ON_CAPACITY = 'true'
