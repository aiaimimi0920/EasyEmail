...
def main() -> int:
    ...
    if (
        ...
        print("[easy-email] remote config fingerprint unchanged; skipping sync")
        return 0

    print(
        "[easy-email] downloading runtime config from R2 "
    ...
    if runtime_env_key:
        print(
            "[easy-email] downloading runtime env from R2 "
